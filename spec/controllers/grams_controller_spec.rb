...
RSpec.describe GramsController, type: :controller do
  describe "grams#destroy" do
    it "shouldn't allow users who didn't create a gram destroy it" do
  ...
  describe "grams#update" do
    it "shouldn't allow users who didn't create the gram update it" do
      ...
      u = FactoryGirl.create(:user)
      sign_in u
      patch :update, id: gram.id, gram: { message: 'meh' }
      expect(response).to have_http_status(:forbidden)
    end
  ...
  describe "grams#show action" do
    ...
    it "should return a 404 errror if the gram is not found" do
      get :show, id: 'TACOCAT'
      expect(response).to have_http_status(:not_found)
    end
  end
